describe("BankingUtils", function(){
    ...
    xit("Testing spy for getting calculating interest", function(){
        // calling calculateInterest
        console.log("calc interest with PTR called...")
    ...
    xit("Testing for calculating Simple Interest ", function(){

        console.log(citi.calculateInterest());
        expect(401).toBe(citi.calculateInterest());
    })


     xit("checking credit score", function(){

         expect(citi.checkCreditScore(4000, 222)).toBeTruty();
     })
...
xdescribe("Spy with parameter", function(){
